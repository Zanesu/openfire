...
/**
 * Collects statistics of an {@link org.apache.mina.common.IoService}. It's
 * polling all the sessions of a given IoService. It's attaching a
 * {@link org.apache.mina.management.IoSessionStat} object to all the sessions
 * polled and filling the throughput values.
 *
 * Usage :
 * 
 * <pre>
 ...
 * </pre>
 *
 * By default the {@link org.apache.mina.management.MINAStatCollector} is
 * polling the sessions every 5 seconds. You can give a different polling time
 * using a second constructor.
 * <p>
 *
 * Note: This class is a spin-off from StatCollector present in
 * https://svn.apache.org/repos/asf/mina/branches/1.1/core/src/main/java/org/
 * apache/mina/management.
 *
...
public class MINAStatCollector {
	 ...
	 * {@link org.apache.mina.management.IoSessionStat}.
	 */
	...
	/**
	 * Create a stat collector for the given service with a default polling time
	 * of 5 seconds.
	 * 
	 * @param service
	...
	/**
	 * Start collecting stats for the {@link org.apache.mina.common.IoSession}
	 * of the service. New sessions or destroyed will be automaticly added or
	 * removed.
	 */
	public void start() {
		synchronized (this) {
			...
			Map<Long, IoSession> sessions = null;
			if (service == null) {
				sessions = null;
			} else {
				sessions = service.getManagedSessions();
			}
			if (sessions != null) {
	 ...
	 * {@link org.apache.mina.management.IoSessionStat} object will be removed
	 * of the polled session attachements.
	 */
	public void stop() {
		synchronized (this) {
	 ...
	 * {@link org.apache.mina.common.IoSession} of the
	 * {@link org.apache.mina.common.IoService}
	 * 
